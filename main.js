const works = [
    ...
    },
    {
        ...
        category: 'Python',
        desc: 'Verity是国外博主ThatMob制作的视频中的角色，由爱好者将其制作成模组，由于中国网络限制，可能无法访问ollama或者groq，这个工具将国内ai平台的api包装成Verity模组可调用的接口，方便国内玩家使用。',
        fullDesc: '工具特色：可以选择六种国内ai平台，包括通义千问，智谱，字节跳动豆包，DeepSeek，MiniMax。选择后，输入模型名称以及密钥，即可点击开始运行。上次输入的模型名称以及密钥会记录进ini，下一次启动时会自动填充。',
